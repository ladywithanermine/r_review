...
# Question 3
# Fit the hierarchical model proposed in Question 2 with JAGS by adjusting the code 
# given in the quiz from Lesson 9 (below). 
# The following R code will be necessary to reproduce the results.
